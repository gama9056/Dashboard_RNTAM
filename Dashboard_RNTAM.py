...
<style>
    ...
    .block-container {
        padding-top: 1rem !important;    /* Reduce el espacio interno superior de la página (por defecto suele ser 6rem). */
        padding-bottom: 1rem !important; /* Ajusta el espacio de abajo para que quede simétrico. */
    }
